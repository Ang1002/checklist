...
<header>
  ...
  <center>
    <div class="col-md-12 text-center">
      <h3 class="animate-charcter">Areas</h3>
    </div>
  </center>
  <center>
  <?php
...
<tr>
            ...
            <!-- <td><button type="submit" class="button">Guardar</button></td> -->
            <td>
            <a class="button" onclick="enviarAlerta(<?php echo $fila['id']; ?>, '<?php echo utf8_encode($fila['elemento']); ?>', '<?php echo utf8_encode($fila['area']); ?>')">Alerta</a>
            <div id="mensaje"></div>
            <!--
