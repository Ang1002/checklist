...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['lunes'])) {
      foreach ($_POST['lunes'] as $id) {
          $sql = "UPDATE servidores SET lunes = CURRENT_DATE WHERE id = $id";
          $conn->query($sql);
    ...
    if(isset($_POST['martes'])) {
      foreach ($_POST['martes'] as $id) {
          $sql = "UPDATE servidores SET martes = CURRENT_DATE WHERE id = $id";
          $conn->query($sql);
          echo '<script>mostrarMensaje();</script>';
      }
    }
    if(isset($_POST['miercoles'])) {
      foreach ($_POST['miercoles'] as $id) {
          $sql = "UPDATE servidores SET miercoles = CURRENT_DATE WHERE id = $id";
          $conn->query($sql);
          echo '<script>mostrarMensaje();</script>';
      }
    }
    if(isset($_POST['jueves'])) {
      foreach ($_POST['jueves'] as $id) {
          $sql = "UPDATE servidores SET jueves = CURRENT_DATE WHERE id = $id";
          $conn->query($sql);
          echo '<script>mostrarMensaje();</script>';
      }
    }
    if(isset($_POST['viernes'])) {
      foreach ($_POST['viernes'] as $id) {
          $sql = "UPDATE servidores SET viernes = CURRENT_DATE WHERE id = $id";
          $conn->query($sql);
          echo '<script>mostrarMensaje();</script>';
      }
    }
...
<form action="correo_server.php" method="GET">
